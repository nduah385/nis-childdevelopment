...
(function(){
  ...
  var css23=document.createElement('link');css23.rel='stylesheet';css23.href='assets/admin-version.v2.3.3.css?v=2.3.3';document.head.appendChild(css23);

  var isAdmin=new URLSearchParams(location.search).get('admin')==='1';
  if(isAdmin){
    var js21=document.createElement('script');js21.type='module';js21.src='assets/enhancements.v2.1.0.js?v=2.3.3';document.head.appendChild(js21);
    var js22=document.createElement('script');js22.type='module';js22.src='assets/enhancements.v2.2.0.js?v=2.3.3';document.head.appendChild(js22);
    var recovery=document.createElement('script');recovery.type='module';recovery.src='assets/password-recovery.v2.3.1.js?v=2.3.3';document.head.appendChild(recovery);
    var visibility=document.createElement('script');visibility.src='assets/password-visibility.v2.3.2.js?v=2.3.3';document.head.appendChild(visibility);
  }else{
    var pub=document.createElement('script');pub.src='assets/public-enhancements.v2.2.3.js?v=2.3.3';document.head.appendChild(pub);
  }
})();