window.NIS_CONFIG = {
  ...
  version: "2.3.6-neon-r2-single-admin",
...
(function(){
  ...
  if(isAdmin){
    ...
    var contactCss=document.createElement('link');contactCss.rel='stylesheet';contactCss.href='assets/contact-panel.v2.3.6.css?v=2.3.6';document.head.appendChild(contactCss);
    ...
    var contactJs=document.createElement('script');contactJs.src='assets/contact-panel.v2.3.6.js?v=2.3.6';document.head.appendChild(contactJs);
  }
})();