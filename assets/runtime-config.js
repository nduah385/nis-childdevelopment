window.NIS_CONFIG = {
  ...
  version: "2.3.6.1-neon-r2-single-admin",
...
(function(){
  ...
  if(isAdmin){
    ...
    var contactJs=document.createElement('script');contactJs.src='assets/contact-panel.v2.3.6.js?v=2.3.6.1';document.head.appendChild(contactJs);
  }
})();