window.NIS_CONFIG = {
  ...
  version: "2.3.4-neon-r2-single-admin",
...
(function(){
  ...
  if(isAdmin){
    ...
    var visibility=document.createElement('script');visibility.src='assets/password-visibility.v2.3.2.js?v=2.3.4';document.head.appendChild(visibility);
  }else{
    var pub=document.createElement('script');pub.src='assets/public-enhancements.v2.2.3.js?v=2.3.4';document.head.appendChild(pub);
  }
})();