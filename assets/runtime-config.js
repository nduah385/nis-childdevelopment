...
(function(){
  ...
  /* CSS is lightweight and shared by public/admin presentation. */
  ...
  if(isAdmin){
    /* Full management code loads only on the private administration entry. */
    var js21=document.createElement('script');js21.type='module';js21.src='assets/enhancements.v2.1.0.js?v=2.2.3';document.head.appendChild(js21);
    var js22=document.createElement('script');js22.type='module';js22.src='assets/enhancements.v2.2.0.js?v=2.2.3';document.head.appendChild(js22);
  }else{
    /* Public visitors get one small, observer-free theme/video script only. */
    var pub=document.createElement('script');pub.src='assets/public-enhancements.v2.2.3.js?v=2.2.3';document.head.appendChild(pub);
  }
})();